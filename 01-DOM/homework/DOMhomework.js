...
// Tu código acá:
document.querySelector("#createdBy").innerHTML = "Aplicación creada por Jorge Luis";
...
function buildToDo(todo, index) {
  ...
  toDoText.addEventListener('click', completeToDo)//Linea 157
...
function displayToDos() {
  ...
  var res = buildToDos(toDoItems); //3
